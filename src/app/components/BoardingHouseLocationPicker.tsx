...
import { MapPin, Star, Plus, Minus, Layers, LocateFixed, Loader2, Phone, Globe, ExternalLink, AlertTriangle, Check } from "lucide-react";
  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      <p style={{ fontSize: 11, color: "#9CA3AF", margin: "0 0 10px", lineHeight: 1.5 }}>
        Tap your boarding house location on the map.
      </p>
      ...
      {/* Interactive map — tapping it decides everything; no pin-type buttons */}
      <div style={{
        position: "relative", height: 230, borderRadius: 18, overflow: "hidden",
        border: `1.5px solid ${hasError ? "#EF4444" : "#E5E7EB"}`, marginBottom: 10,
      }}>
        ...
        {placeStatus === "lookup_failed" && (
          <div style={{
            position: "absolute", left: 12, right: 12, top: 12, zIndex: 20,
            background: "rgba(254,242,242,.97)", border: "1px solid #FECACA", borderRadius: 12, padding: "8px 12px",
            ...
            <span style={{ fontSize: 11, color: "#B91C1C", fontFamily: IN, lineHeight: 1.5 }}>
              Couldn't load that place's information. A pin was dropped here instead — drag it and enter the address yourself, or try tapping the place again.
            </span>
          </div>
        )}

        {/* Map controls: zoom, satellite toggle, locate me */}
